...
public abstract class Ship extends Entity {
	...
	protected Ship(Type type, Type[] targetPriorities, float[] targetSearchLimits, int health, float diameter, float turnSpeed, float acceleration, float maxVelocity) {
